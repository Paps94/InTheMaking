...
<div class="jumbotron">
  <div class="container con">
    ...
    <h1 class="display-3">New Task pretty boy?</h1>
    <p>Wohoooooooooo!</p>
    <a class="btn btn-primary btn-lg viewbtn" href="{{ route('tmissues.index') }}" role="button">View All Tasks</a>
  </div>
</div>
  ...
  <div class="container con">
    <div class="row row-45 row-md-60 submit-form text-left">
      <div class="col-12">
        <!-- RD form-->
        <form method="post" action="{{ route('tmissues.store') }}" class="inset-6">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <input class="btn btn-lg btn-primary submitBtn" type="submit" value="Submit New Task"/>
          </div>
      </div>
    </form>
  </div>
